 ...
 */
final class Version20241001120101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT NOT NULL, course_title_id INT NOT NULL, type_course_id INT NOT NULL, saesupport VARCHAR(20) DEFAULT NULL, group_max_number INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE course_title (id INT NOT NULL, module_id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C29D7F83AFC2B591 ON course_title (module_id)');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, login VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL ON "user" (email)');
        $this->addSql('CREATE TABLE week (id INT NOT NULL, number INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE course_title ADD CONSTRAINT FK_C29D7F83AFC2B591 FOREIGN KEY (module_id) REFERENCES module (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course_title DROP CONSTRAINT FK_C29D7F83AFC2B591');
